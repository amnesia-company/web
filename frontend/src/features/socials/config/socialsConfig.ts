...
export const socialsConfig = [
    {icon: discord, ariaLabel: "ariaLabel.goToDiscord", href: "https://discord.gg/yWAgBjXVHD", alt: "header.discordAlt"},
    {icon: telegram, ariaLabel: "ariaLabel.goToTelegram", href: "2", alt: "header.telegramAlt"},
    {icon: vkontakte, ariaLabel: "ariaLabel.goToVkontakte", href: "https://vk.com/futureside_mc", alt: "header.vkontakteAlt"},
